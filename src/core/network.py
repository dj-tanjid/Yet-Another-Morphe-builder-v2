...
class NetworkManager:
    def __init__(self) -> None:
        # Give every thread its own independent browser string and session to prevent cross-thread contamination
    ...
    def _rotate_browser(self, url: str) -> None:
        """Rotates the underlying TLS fingerprint."""
        try:
            self.session.close() 
        except Exception:
            pass
        ...
        # Run Playwright and inject the clearance cookies directly into the new session
